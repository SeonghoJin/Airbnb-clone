...
import { Bean, Connect } from "typejnu";
...
var ConcreteUserRepository = /** @class */ (function () {
    ...
    ConcreteUserRepository.prototype.getUserById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.database.find({ id: id })];
            });
        });
    };
    ...
    ConcreteUserRepository.prototype.insert = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.database.insert(user)];
            });
        });
    };
    __decorate([
